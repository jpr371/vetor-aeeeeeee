...
class Exercicio09
{
    static void Main()
    {
        Console.Write("Digite a quantidade de funcionários (n): ");
        int n = int.Parse(Console.ReadLine()!);
        ...
        Console.WriteLine($"\nA soma de todos os salários no vetor é: R$ {somaTotal:F2}");
    }
}*/
...
class Exercicio10
{
    static void Main()
    {
        Console.Write("Digite a quantidade de temperaturas (n): ");
        int n = int.Parse(Console.ReadLine()!);
        ...
        for (int i = 0; i < n; i++)
        {
            Console.Write($"Digite a {i + 1}ª temperatura: ");
            temperaturas[i] = double.Parse(Console.ReadLine()!);
            soma += temperaturas[i];
        }   
        double media = soma / n;
        Console.WriteLine($"\nA média das temperaturas inseridas é: {media:F2}°C");
    }
}*/
...
class Exercicio11 {
    static void Main() {
        ...
        int[] resultadoCubo = new int[n];
        for (int i = 0; i < n; i++) {
            v[i] = int.Parse(Console.ReadLine()!);
            resultadoQuadrado[i] = v[i] * v[i];
            resultadoCubo[i] = v[i] * v[i] * v[i];
        }

        Console.WriteLine("Quadrados: " + string.Join(", ", resultadoQuadrado));
        Console.WriteLine("Cubos: " + string.Join(", ", resultadoCubo));
    }
}*/
...
class Exercicio13
{
    static void Main()
    {
        ...
        for (int i = 0; i < n; i++)
        {
            Console.Write($"Digite o {i + 1}º número: ");
            vetor[i] = int.Parse(Console.ReadLine()!);
            somaQuadrados += Math.Pow(vetor[i], 2);
        }
        double mrq = Math.Sqrt(somaQuadrados / n);

        Console.WriteLine($"\nMRQ (Média da Raiz Quadrada): {mrq:F2}");
    }
}*/
